const isValidNode = (row:any, col:any, value:any, board:any) => {
...
const getNode = (row:any, column:any, value:any, isModifiable:any) => {
  return {
    row: row,
    column: column,
    value: value,
...
const createSudokuGrid = (maxEmptyCellsCount:number) => {
